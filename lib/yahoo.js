...
class Yahoo extends Quotes {
    ...
    buildHistoryURL(security) {
        return 'http://query1.finance.yahoo.com/v7/finance/download/'+security.yticker+(security.country!='United States'?'.TO':'')+'?period1=1520786681&period2=1523465081&interval=1d&events=history&crumb=j/EP.nt7PHp';
    }
